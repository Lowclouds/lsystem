...
p1: M < B -->  ;(65)@H(1)^(TUBEANGLE)!(TUBEBASE)@#('pc'){(0).!(TOP_SIZE)f(TUBELEN)}(8,'petal')M
/* end extrusion and save it as surface 'petal' 
p3: E --> .f(TUBELEN)}(8,'petal')M
*/
/* contour definition */ 
p4: C --> @DsD(0)@De('pc')
...
p7: M < H -> @H(1)I(NP)
p8: I(p) : p > 0 --> g(-1*TUBEBASE)^(90)~('petal',1)&(90)g(TUBEBASE)^(90)\(BETA)&(90)I(p-1)
p9: I(p) : p == 0 --> *
p10: M -> *
