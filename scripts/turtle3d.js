class Turtle3d {
	...
	case 'string': {
	    ...
	    case 'blue': {c = BABYLON.Color3.Blue(); break;}
	    case 'gray': {c = BABYLON.Color3.Gray(); break;}
	    case 'green': {c = BABYLON.Color3.Green(); break;}
	    case 'magenta': {c = BABYLON.Color3.Magenta(); break;}
	    case 'purple': {c = BABYLON.Color3.Purple(); break;}
	    case 'red': {c = BABYLON.Color3.Red(); break;}
	    case 'teal': {c = BABYLON.Color3.Teal(); break;}
	    case 'white': {c = BABYLON.Color3.White(); break;}
	    case 'yellow': {c = BABYLON.Color3.Yellow(); break;}
	    case 'black':
	    default: { c = BABYLON.Color3.Black();}
	    }
	    this.TurtleState.Color = c;
	}
	    break;
	case 'array': {
	    this.TurtleState.Color.fromArray(v);
	}
	    break;
	case 'object': { 	// assume it's a color3 object
	    this.TurtleState.Color = v;}
	}
