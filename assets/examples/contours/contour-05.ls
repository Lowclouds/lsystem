/*
  ...
  This creates a contour using the Bezier spline module, @Cb, which requires four points
  in the contour buffer, which will all be replaced by the generated segment.
...
A(t) : t > MAXSTEPS --> *
C --> [@H(1)@Cs(60)@Cn(60).^(120)f(3)&(120)f&(30)f(2)@Cb@Ce('ctr')]
